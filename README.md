...
![Traffic and Connections](docs/screenshots/dashboard-traffic.png)

### Client Visibility

![Client Visibility](docs/screenshots/dashboard-clients.png)

### Audit Events and Export

![Audit Events and Export](docs/screenshots/dashboard-events.png)

### Ban Management

![Ban Management](docs/screenshots/dashboard-bans.png)

### Administrative Actions

![Administrative Actions](docs/screenshots/dashboard-actions.png)

### Logs and System Output

![Logs and System Output](docs/screenshots/dashboard-logs.png)

### Navigation Sidebar

![Navigation Sidebar](docs/screenshots/dashboard-navigation.png)
